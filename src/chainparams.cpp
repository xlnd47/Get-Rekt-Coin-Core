...
// Copyright (c) 2020 The GetRektCoin Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1591051509, nBits=1e0ffff0, nNonce=4299284, vtx=1)
...
{
    const char* pszTimestamp = "Today is 02 06 2020";
    const CScript genesisOutputScript = CScript() << ParseHex("043d0aa2b2d5ab087262913b3ff75655d0059e8c6e9db3535977508b319f8eca629ab8345a4adb3f24bc4847ecf240517c576b999d8fff70b6735d69c6266d121a") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000007f506958a40acd7104379e4690f1d1ff27f3b6a1526fc1107e88bedb1ec"); 
        ...
        vAlertPubKey = ParseHex("04095c7672912ab6f3c6734873160dc96acaf2bce8aece8278c44dd0c5171729b60e77b1fc54df587fe0bf487120becd8fa9b3dd29be9964f74e211b2feabe089a");
        nDefaultPort = 19818;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1591051509, 4299284, 0x1e0ffff0, 1, 100 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000007f506958a40acd7104379e4690f1d1ff27f3b6a1526fc1107e88bedb1ec"));
        assert(genesis.hashMerkleRoot == uint256S("0xfd4ba966e4f3fc8a18507d9934f1487ef52a26065a20e773997f0df5f630ff72"));


        vSeeds.push_back(CDNSSeedData("walletbuilders.com", "node1.walletbuilders.com"));
        vSeeds.push_back(CDNSSeedData("getrekt.wtf", "node1.getrekt.wtf"));
        ...
        // GetRektCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // GetRektCoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // GetRektCoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"XS5hSfTULzvfbVvH5heNoJJsxSMqGRUPgd"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x000007f506958a40acd7104379e4690f1d1ff27f3b6a1526fc1107e88bedb1ec"))
        };

        chainTxData = ChainTxData{
            1591051509, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000a664c4604735134629f03a7bc085c43332b157f81b50a8a3184d59633a8"); 

        pchMessageStart[0] = 0x88;
        pchMessageStart[1] = 0x41;
        pchMessageStart[2] = 0xe6;
        pchMessageStart[3] = 0x99;
        vAlertPubKey = ParseHex("04e19e3456402f8727f88b36a05c0a0df7f599c7ff01750e7ec842ba853d5a728dc95ef28ee6c2eae8ef774e0dc073f17912d1f354be70f135dfd93e6869116b84");
        nDefaultPort = 29818;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1591051514UL, 1574601UL, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000a664c4604735134629f03a7bc085c43332b157f81b50a8a3184d59633a8"));
        assert(genesis.hashMerkleRoot == uint256S("0xfd4ba966e4f3fc8a18507d9934f1487ef52a26065a20e773997f0df5f630ff72"));
        ...
        // Testnet GetRektCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet GetRektCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet GetRektCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"TAEu2Nmp3FKT6x4AkbTfcQ3Rzi8xJKdaZC"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000a664c4604735134629f03a7bc085c43332b157f81b50a8a3184d59633a8"))
        };

        chainTxData = ChainTxData{
            1591051514, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1591051519, 1, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x160ec92f266a8a0247afc903e0bd86fc345733f22278fbeb37889ff7f2b9e4fe"));
        assert(genesis.hashMerkleRoot == uint256S("0xfd4ba966e4f3fc8a18507d9934f1487ef52a26065a20e773997f0df5f630ff72"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("getrektcoinevo.org",  "devnet-seed.getrektcoinevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x160ec92f266a8a0247afc903e0bd86fc345733f22278fbeb37889ff7f2b9e4fe"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 7UCzxkdCPAY3Rm9c1gWNDjydeozoScaRHhy4mjLNwsKT7tXKjwB
        vSporkAddresses = {"TDw1mV8sQcwmwBKF2Ab6YyWVXYWkAfucBZ"};
        nMinSporkKeys = 1;
        ...
        // Regtest GetRektCoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest GetRektCoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest GetRektCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest GetRektCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest GetRektCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
