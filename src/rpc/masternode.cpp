...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner GetRektCoin address\n"
            "  payee          - Print the masternode payout GetRektCoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting GetRektCoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "getrektcoin",               "masternode",             &masternode,             true,  {} },
    { "getrektcoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "getrektcoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "getrektcoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
