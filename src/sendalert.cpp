...
2. run getrektcoind with -printalert or -sendalert like this:
   /path/to/getrektcoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.getrektcoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/GetRektCoin Core:0.12.0.58/"));
