...
#define BOOST_TEST_MODULE GetRektCoin Test Suite

#include "test_getrektcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_getrektcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
