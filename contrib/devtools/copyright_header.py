...
EXPECTED_HOLDER_NAMES = [
    ...
    "The GetRektCoin Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a GetRektCoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The GetRektCoin Core developers'
...
Arguments:
    <base_directory> - The base directory of GetRektCoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the GetRektCoin Core repository.
"""
