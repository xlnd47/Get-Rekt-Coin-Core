...
from test_framework.test_framework import GetRektCoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(GetRektCoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as GetRektCoinTestFramework doesn't support this atm)
