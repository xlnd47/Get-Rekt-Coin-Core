...
official/supported Docker Images found at https://hub.docker.com/r/getrektcoinpay/getrektcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/getrektcoinpay/getrektcoind-develop/ when changing the above text**