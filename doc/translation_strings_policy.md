...
This document provides guidelines for internationalization of the GetRektCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `getrektcoin_en.ts` remains unchanged.
