...
This mechanism has been integrated into Bitcore-Node-GetRektCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/getrektcoinpay/insight-api-getrektcoin#web-socket-api](https://github.com/getrektcoinpay/insight-api-getrektcoin#web-socket-api)
* API: [https://github.com/getrektcoinpay/insight-api-getrektcoin#instantsend-transactions](https://github.com/getrektcoinpay/insight-api-getrektcoin#instantsend-transactions)
